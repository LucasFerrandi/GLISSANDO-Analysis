...
/*
Esse programa recebe os .points gerados pelo GLISSANDO3 e produz histogramas das densidades
de energia que podem ser salvos ou não, tanto como .png quanto .root. Então calcula as quantidades:
  epsfixfireball,
  epspartfireball,
  mediaepsfix,
  desvpadmed_epsfix,
  ...
  mediaphrot e
  desvpadmed_phrot
para cada r2_hs, b e SEED e as salva em um arquivo .txt.
Usado junto com o ProduzResults.sh, esse programa também salva essas grandezas para diferentes r2_hs, b e SEED e salva num outro .txt.
